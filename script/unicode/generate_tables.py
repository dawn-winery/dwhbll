...
""" + "\n\n".join([cpp_ranges(name, body) for name, body in data.items()]) + "\n\n}"
...
def main() -> None:
    ...
    output = generate_cpp({"XID_Start": xid_start, "XID_Continue": xid_continue, "ID_Compat_Math_Start": id_copmpat_math_start, "ID_Compat_Math_Continue": id_copmpat_math_continue})
